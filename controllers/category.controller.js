...
exports.findAll = async (req, res) => {
    ...
    try {
        ...
        console.log("Success Finding all Categories");
    } catch (err){
        res.status(400).json({status: false, data: err});
        console.log("Problem Finding all Categories");        
    }
}
...
exports.findOne = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({status: true, data: result});
        console.log("Success Finding category with id: " + id);
    } catch (err)
    {
        res.status(400).json({status: false, data: err});
        console.log("Problem finding category with id " + id);
    }
}
...
exports.create = async (req, res) => {
    ...
    console.log("Insert new category name: " + name);
